...
void nexttobdypoints_freepts_(real *chrbdy, 
                      int *numbdypoints, int *extrap_order, real *smallest_rho_extrap, real *x, real *y, real *z, real *chr, real *AdS_L, real *ex, int *Nx, int *Ny, int *Nz,  int *phys_bdy, int *ghost_width);

void nexttobdypoints_fixedpts_(real *chrbdy,
                      int *numbdypoints, int *extrap_order, int *ind_distance_fixedpts, real *currentres_ratio_Lhighres_Llowres, int *num_fixed_coords, real *fixed_coords, real *smallest_rho_extrap, real *x, real *y, real *z, real *chr, real *AdS_L, real *ex, int *Nx, int *Ny, int *Nz,  int *phys_bdy, int *ghost_width);
