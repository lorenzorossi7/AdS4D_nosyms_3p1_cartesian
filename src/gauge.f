...
c----------------------------------------------------------------------
          ...
          do i=2,Nx-1
            do j=2,Ny-1
              if (chr(i,j).ne.ex) then
                ...
                F_t_np1=
     &                 +gb_tx_np1(i,j)*1.5d0*x0/rho0*f1
     &                 +gb_ty_np1(i,j)*1.5d0*y0/rho0*f1
     ...
     &                 (-1+rho0**2)**4))
                ...
                betax0=gb_tx_np1(i,j)
                betay0=gb_ty_np1(i,j)
          ...
          do i=2,Nx-1
            do j=2,Ny-1
              if (chr(i,j).ne.ex) then
                ...
                F_x_np1=gb_xx_np1(i,j)*1.5d0*x0/rho0*f1
     &                 +gb_xy_np1(i,j)*1.5d0*y0/rho0*f1
     &                 +gb_xx_np1(i,j)*cbulk*x0*(1-f1)
     &                 +gb_xy_np1(i,j)*cbulk*y0*(1-f1)
                F_y_np1=gb_yy_np1(i,j)*1.5d0*y0/rho0*f1
     &                 +gb_xy_np1(i,j)*1.5d0*x0/rho0*f1
